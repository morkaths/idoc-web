...
export const BookApi = {
  ...
  findById: async (id: string): Promise<Book | null> => {
    const response = await ApiRequest.apiGet<Book>(API_CONFIG.endpoints.book.findById(id), {
      mode: 'public',
    });
    if (response.success && response.data) {
  ...
  create: async (data: Partial<Book>): Promise<Book | null> => {
    const response = await ApiRequest.apiPost<Book>(API_CONFIG.endpoints.book.create, {
      mode: 'private',
      data: data,
    });
    if (response.success && response.data) {
  ...
  update: async (id: string, data: Partial<Book>): Promise<Book | null> => {
    const response = await ApiRequest.apiPatch<Book>(API_CONFIG.endpoints.book.update(id), {
      mode: 'private',
      data: data,
    });
    if (response.success && response.data) {
  ...
  delete: async (id: string): Promise<boolean> => {
    const response = await ApiRequest.apiDelete<null>(API_CONFIG.endpoints.book.delete(id), {
      mode: 'private',
    });
