...
export const useCreateCollection = () => {
    ...
    return useMutation({
        mutationFn: (newCollection: Partial<Collection>) => CollectionApi.create(newCollection),
        onSuccess: () => {
...
export const useUpdateCollection = () => {
    ...
    return useMutation({
        mutationFn: ({ id, data }: { id: string; data: Partial<Collection> }) => CollectionApi.update(id, data),
