...
// turbo 2. Format all TypeScript and Markdown files with Prettier:
...
// turbo 3. Run Knip to detect unused files, dependencies, and exports:
...
// turbo 4. Lint only admin:

```bash
npm run lint --workspace=admin
```

// turbo 5. Lint only web:
