...
const factory = apiFactory<LoanResponse, BorrowRequest>(ApiEndpoint.endpoints.borrows, {
  find: 'public',
  findById: 'public',
});
...
export const BorrowApi = {
  ...
  history: async (
    ...
    return ApiClient.get<PageResponse<LoanResponse>>(ApiEndpoint.endpoints.borrows.history(), {
      security: 'private',
      params,
    });
  },
  ...
  extend: async (
    ...
    return ApiClient.put<LoanResponse>(ApiEndpoint.endpoints.borrows.extend(id), {
      security: 'private',
      data: request,
    });
  },
  ...
  return: async (id: string): Promise<ApiResponse<LoanResponse>> => {
    return ApiClient.post<LoanResponse>(ApiEndpoint.endpoints.borrows.return(id), {
      security: 'private',
    });
  },
