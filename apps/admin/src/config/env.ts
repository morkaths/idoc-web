...
export const BASE_URL: string = (raw.VITE_BASE_URL ??
  'http://localhost:5173') as string

export const API_URL: string = (raw.VITE_API_URL ??
  'http://localhost:8000/api') as string

export const API_KEY: string | undefined = (raw.VITE_API_KEY ?? undefined) as
  | string
  | undefined
