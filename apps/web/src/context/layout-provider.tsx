...
const LAYOUT_COLLAPSIBLE_COOKIE_NAME = 'idoc_layout_collapsible';
const LAYOUT_VARIANT_COOKIE_NAME = 'idoc_layout_variant';
const LAYOUT_HEADER_FIXED_COOKIE_NAME = 'idoc_layout_header_fixed';
const LAYOUT_MAIN_FIXED_COOKIE_NAME = 'idoc_layout_main_fixed';
