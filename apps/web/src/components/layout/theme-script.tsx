...
/**
 * Script chặn FOUC (Flash of Unstyled Content) và xử lý theme hệ thống
 * Được nhúng trực tiếp vào head để chạy trước khi React hydrate
 */
export function ThemeScript({ theme }: { theme: any }) {
    const scriptContent = `
    try {
