        ...
        renderToolbar: (Toolbar) => (
            <Toolbar>
                {(slots) => {
                    ...
                    const { ShowSidebar } = slots as unknown as { ShowSidebar?: React.ComponentType<{ children: (props: { onClick: () => void }) => React.ReactNode }> };
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                                ...
                                <GoToPreviousPage>
                                    {(props: RenderGoToPageProps) => (
                                        <Button variant="ghost" size="icon" onClick={props.onClick} disabled={props.isDisabled} className={buttonClass} style={toolStyle}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                                <ZoomOut>
                                    {(props: RenderZoomOutProps) => (
                                        <Button variant="ghost" size="icon" onClick={props.onClick} className={buttonClass} style={toolStyle}>
