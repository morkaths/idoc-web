...
export const CategoryApi = {
  ...
  findAll: async (params?: FindParams): Promise<Category[]> => {
    try {
      const endpoint =
        (API_CONFIG.endpoints as any)?.category?.findAll ?? API_CONFIG.endpoints.category.find;
  ...
  findById: async (id: string): Promise<Category | null> => {
    const response = await ApiRequest.apiGet<Category>(API_CONFIG.endpoints.category.findById(id), {
      mode: 'public',
    });
  ...
  create: async (data: Partial<Category>): Promise<Category | null> => {
    const response = await ApiRequest.apiPost<Category>(API_CONFIG.endpoints.category.create, {
      mode: 'private',
      data,
    });
    if (response.success && response.data) return response.data;
  ...
  update: async (id: string, data: Partial<Category>): Promise<Category | null> => {
    const response = await ApiRequest.apiPatch<Category>(API_CONFIG.endpoints.category.update(id), {
      mode: 'private',
      data,
    });
    if (response.success && response.data) return response.data;
  ...
  delete: async (id: string): Promise<boolean> => {
    const response = await ApiRequest.apiDelete<null>(API_CONFIG.endpoints.category.delete(id), {
      mode: 'private',
    });
