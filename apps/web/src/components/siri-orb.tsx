...
const CONTRAST_TINY = 1.3;
const CONTRAST_MULTIPLIER_FINAL = 1.2;
const CONTRAST_MIN_FINAL = 1.4;
  ...
  return (
    ...
    >
      <style>{`
        ...
        .siri-orb::before {
          background:
            conic-gradient(from calc(var(--angle) * 2) at 35% 65%, var(--c3), transparent 20% 80%, var(--c3)),
            conic-gradient(from calc(var(--angle) * 2) at 45% 60%, var(--c2), transparent 30% 60%, var(--c2)),
            conic-gradient(from calc(var(--angle) * -3) at 65% 35%, var(--c1), transparent 40% 60%, var(--c1)),
            conic-gradient(from calc(var(--angle) * 2) at 30% 30%, var(--c2), transparent 10% 90%, var(--c2)),
            conic-gradient(from calc(var(--angle) * 1) at 40% 65%, var(--c1), transparent 10% 90%, var(--c1)),
            conic-gradient(from calc(var(--angle) * -2) at 60% 30%, var(--c3), transparent 20% 80%, var(--c3));
